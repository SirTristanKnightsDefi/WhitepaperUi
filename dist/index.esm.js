...
var Logo = function (_a) {
    ...
    if (isDark) {
        banner = 'https://gateway.pinata.cloud/ipfs/QmcLiFDQbAA1g8NbP7o9RmcWTohPdAdKPivHJBz6y3Y7UT';
    }
    else {
        banner = 'https://gateway.pinata.cloud/ipfs/QmcLiFDQbAA1g8NbP7o9RmcWTohPdAdKPivHJBz6y3Y7UT';
    }
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "WP home page" },
            React.createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmcLiFDQbAA1g8NbP7o9RmcWTohPdAdKPivHJBz6y3Y7UT", alt: "WP Logo", className: "mobile-icon" }),
            React.createElement("img", { src: banner, alt: "WP Logo", className: "desktop-icon" }))) : (React.createElement(StyledLink, { to: href, "aria-label": "WP home page" },
            React.createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmcLiFDQbAA1g8NbP7o9RmcWTohPdAdKPivHJBz6y3Y7UT", alt: "WP Logo", className: "mobile-icon" }),
            React.createElement("img", { src: banner, alt: "WP Logo", className: "desktop-icon" })))));
};
var templateObject_1$c;
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/Whitepapercoinofficial",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/WhitepaperO",
    },
];
var MENU_HEIGHT = 64;
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/", target: "_blank" },
            React.createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmcLiFDQbAA1g8NbP7o9RmcWTohPdAdKPivHJBz6y3Y7UT", alt: "WP Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f1f6f8", backgroundDisabled: "#E9EAEB", contrast: "#43AA8B", invertedContrast: "#FFFFFF", input: "#eeeeee", tertiary: "#EFF4F5", text: "#C8C9CA", textDisabled: "#BDC2C4", textSubtle: "#C8C9CA", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#C8C9CA", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#000000", tertiary: "#353547", text: "#C8C9CA", textDisabled: "#666171", textSubtle: "#C8C9CA", borderColor: "#524B63", card: "#27262c", gradients: {
